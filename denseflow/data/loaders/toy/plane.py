import torch
from denseflow.data import TrainTestLoader
from denseflow.data.datasets.toy import GaussianDataset, CrescentDataset, CrescentCubedDataset, SineWaveDataset, AbsDataset, SignDataset, FourCirclesDataset, DiamondDataset, TwoSpiralsDataset, TwoMoonsDataset, TestGridDataset, CheckerboardDataset, FaceDataset
